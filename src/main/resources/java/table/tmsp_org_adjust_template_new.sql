...
update bmsp.bmsp_should_outorder set fee_bear_orgid = '<新机构ID>' where fee_bear_orgid in('<老机构ID>');
...
update bds.bds_backdoc_info set backdoc_handover_org = '<新机构ID>' where backdoc_handover_org in('<老机构ID>');
...
update isp.isp_work_issues_info set source_org_id='<新机构ID>',source_org_name='<新机构名称>' where source_org_id in('<老机构ID>');