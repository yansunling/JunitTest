...
public class FindOrgSql implements ApplicationContextAware{
	...
	public  void test() throws Exception {
		OrgData orgDataTemp=new OrgData("'250109040703'","'25010904030301','25010904030302','25010904030303'","'绍兴线路管理三组'","'柯西新疆收货点','北二区新疆收货点','北八区新疆收货点'");
		orgDataTemp.setNewDistrictId("'2501090407'");
		orgDataTemp.setNewRegionId("'25010904'");
		orgDataTemp.setOldOrgList("'25010904030301|25010904030302|25010904030303'");
		orgDataTemp.setOldSingleOrg("'25010904030301'");
		List<OrgData> orgDataList=Arrays.asList(orgDataTemp);
