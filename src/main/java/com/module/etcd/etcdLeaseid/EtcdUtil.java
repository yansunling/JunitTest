 ...
 *    
 */
package com.module.etcd.etcdLeaseid;
...
public class EtcdUtil {
    ...
    public static synchronized Client getEtcdClient(){
        if(null == client){
            client= Client.builder().endpoints("http://192.168.20.98:2379").build();
        }
     return client;
    }
   ...
   public static void setAddress(String address)
   {
    ...
    public static String getEtcdValueByKey(String key) throws Exception {
        ...
        List<KeyValue> kvs = client.getKVClient().get(ByteSequence.from(key,Charset.defaultCharset())).get().getKvs();
        if(kvs.size()>0){
   ...
   public static List<String> getEtcdValueByDir(String key) throws Exception  {
        ...
        if(!kvs.isEmpty()){
            ...
            {
              String value = kvs.get(i).getValue().toString(Charset.defaultCharset());
              lst.add(value);
            }
        }
        return lst;
   ...
   * @return List<String>    返回类型
   ...
   public static Map<String,String> getEtcdKVDir(String key) throws Exception  {
       ByteSequence etcdKey = ByteSequence.from(key, Charset.defaultCharset());
       GetOption op = GetOption.newBuilder().withPrefix(etcdKey).build();

       List<KeyValue> kvs = client.getKVClient().get(etcdKey,op).get().getKvs();
       ...
       if(!kvs.isEmpty()){
           ...
           {
             String value = kvs.get(i).getValue().toString(Charset.defaultCharset());
             String k=kvs.get(i).getKey().toString(Charset.defaultCharset());
             map.put(k, value);
           }
       }
       return map;
    ...
    public static void putEtcdValueByKey(String key,String value) throws Exception{
      client.getKVClient().put(ByteSequence.from(key,Charset.defaultCharset()),ByteSequence.from(value.getBytes(utf8))).get();
    }
    ...
    * @return void    返回类型
    ...
    public static void putEtcdByteByKey(String key,byte[] value) throws Exception{
        client.getKVClient().put(ByteSequence.from(key,Charset.defaultCharset()),ByteSequence.from(value)).get();
      }
    ...
    * @return void    返回类型
    ...
    public static void putEtcdKVOrder(String key,String value)
    {
        ...
        client.getKVClient().put(ByteSequence.from(key,Charset.defaultCharset()), ByteSequence.from(value,Charset.defaultCharset()), option);
    }
    /**
     * 删除指定的配置
     * @param key
    ...
    public static void deleteEtcdValueByKey(String key){
        try {
            client.getKVClient().delete(ByteSequence.from(key,Charset.defaultCharset())).get();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    * @return void    返回类型
    ...
    public static void putEtcdValueByKeyTTL(String key,String value,int ttl) throws Exception{
         ...
         client.getKVClient().put(ByteSequence.from(key,Charset.defaultCharset()),ByteSequence.from(value.getBytes(utf8)),option);
