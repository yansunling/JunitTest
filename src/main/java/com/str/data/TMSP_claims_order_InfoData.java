...
import com.str.data.constants.ACCOUNT_TYPE;
...
public class TMSP_claims_order_InfoData {
    ...
    @CJ_column(name = "总件数",type = MysqlColumnTypeEnum.INT)
    ...
    @CJ_column(name = "签收类型")
    private SIGNIN_STATUS order_close_type;
    @CJ_column(name = "中转承运商")
    private String turn_comp_name;
    @CJ_column(name = "保价费")
    private Money premium;
    @CJ_column(name = "索赔客户类别")
    private CLAIMS_CUSTOMER_TYPE claims_customer_type;
    @CJ_column(name = "开单付款方式")
    private ORDER_PAY_TYPE order_pay_type;
    @CJ_column(name = "现付金额")
    ...
    @CJ_column(name = "回单标记")
    private IS_NOT back_flag;
    @CJ_column(name = "理赔类别")
    private OA_CLAIMS_TYPE claims_type;

    @CJ_column(name = "理赔大类")
    private OA_CLAIMS_BG_TYPE claims_bg_type;

    @CJ_column(name = "理赔小类")
    private OA_CLAIMS_SM_TYPE claims_sm_type;
    ...
    private OA_CLAIMS_DATA_SOURCE claims_data_source= OA_CLAIMS_DATA_SOURCE.OA_CLAIMS_DATA_SOURCE_SEND;
    ...
    private String claims_serial_no;
