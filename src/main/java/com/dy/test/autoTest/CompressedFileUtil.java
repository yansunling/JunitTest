...
import com.dy.components.mqutil.annotation.CJ_jcjs_taskConsumerInfo;
...
public class CompressedFileUtil {
    ...
    public static void compressedFile(String resourcesPath,String targetPath) throws Exception{
        ...
        String targetName = resourcesFile.getName()+".jar";   //目的压缩文件名
    ...
    public static void createCompressedFile(ZipOutputStream out,File file,String dir) throws Exception{
        ...
        if(file.isDirectory()){
        	...
        	String typeName = fileName.substring(fileName.lastIndexOf(".")+1,fileName.length());
        	if(StringUtils.equals("java", typeName)) {
        		//文件输入流
...
//                f.createNewFile();
    ...
    public static void main(String[] args){
        try {
        		CompressedFileUtil.compressedFile("E:/gms", "E:/");
