...
function addNewContent(obj) {
	...
	for(var a = 0; a < imgSrc.length; a++) {
		var oldBox = $(obj).html();
		$(obj).html(oldBox + '<li class="content-img-list-item"><img style="cursor:pointer" src="'+imgSrc[a]+'" alt=""><a index="'+a+'" class="hide delete-btn"><i  class="ico-save"></i><i style="margin-left: 10px" index="'+a+'" class="ico-delete"></i></a>' +
			'</li>');
		...
		$("img").on("click",function(){
			let viewer = new Viewer(document.getElementById('showViewer1'));
			viewer.show();
		});
	}
}
